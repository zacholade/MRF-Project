...
class DataLogger:
    ...
    def log_error(self, predicted, labels, loss, data_type: str):
        ...
        self.log(f"{data_type}_mean_abs_perc_error", mean_abs_perc_error)
        self.log(f"{data_type}_mean_sq_error", mean_sq_error)
        self.log(f"{data_type}_root_mean_sq_error", root_mean_sq_error)
        ...
        self.log(f"{data_type}_t1_mean_abs_perc_error", t1_mean_abs_perc_error)
        self.log(f"{data_type}_t1_mean_sq_error", t1_mean_sq_error)
        self.log(f"{data_type}_t1_root_mean_sq_error", t1_root_mean_sq_error)
        ...
        self.log(f"{data_type}_t2_mean_abs_perc_error", t2_mean_abs_perc_error)
        self.log(f"{data_type}_t2_mean_sq_error", t2_mean_sq_error)
        self.log(f"{data_type}_t2_root_mean_sq_error", t2_root_mean_sq_error)
