...
class SpatioTemporalResLayer(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        if self.spatial_compress or self.temporal_compress:
            ...
            compress_stride_hw = 2 if self.spatial_compress else 1
        ...
        self.conv2 = block(out_channels, out_channels, kernel_size=(21, 1, 1), padding=(10, 0, 0))
...
class R2Plus1DFinal(nn.Module):
    def __init__(self, patch_size: int, seq_len: int, factorise: bool = True):
        ...
        # first conv, with stride 1x1x1 modified from 1x2x2. Kernel size 21x3x3 modified from 3x7x7.
        # Mostly dealing with data in temporal dimension as opposed to video!
        self.conv1 = conv_block(1, 32, kernel_size=(21, 3, 3), stride=(1, 1, 1), padding=(10, 1, 1))
        # output of conv2 is same size as of conv1, no downsampling/compression needed. kernel_size 3x3x3
        self.conv2 = SpatioTemporalResLayer(32, 32, 3, temporal_compress=True, block=conv_block)
        ...
        self.conv3 = SpatioTemporalResLayer(32, 64, kernel_size=3, spatial_compress=False, temporal_compress=True, block=conv_block)
        self.nloc_2 = NonLocalBlock3D(in_channels=64, compression=1)
        self.conv4 = SpatioTemporalResLayer(64, 128, kernel_size=3, spatial_compress=True, temporal_compress=True, block=conv_block)
        ...
        self.conv5 = SpatioTemporalResLayer(128, 256, kernel_size=3, spatial_compress=True, temporal_compress=True, block=conv_block)
